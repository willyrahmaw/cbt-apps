    ...
    <div class="card">
        <div class="illus">
            <svg viewBox="0 0 140 140" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M70 25v20M70 95v20M95 70h20M25 70h20M42 42l14 14M84 84l14 14M84 42l14-14M42 84l-14 14" stroke="url(#g503)" stroke-width="2.5" stroke-linecap="round" opacity="0.6"/>
                <circle cx="70" cy="70" r="35" stroke="url(#g503)" stroke-width="3" fill="none"/>
                <path d="M70 55v20l12 12" stroke="url(#g503)" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                <defs><linearGradient id="g503" x1="0" y1="0" x2="140" y2="140" gradientUnits="userSpaceOnUse"><stop stop-color="#1e3a5f"/><stop offset="1" stop-color="#3b82f6"/></linearGradient></defs>
            </svg>
        </div>
        <div class="code">503</div>
        <h1>Sedang Pemeliharaan</h1>
        <p class="msg">Sistem sedang diperbarui. Mohon tunggu sebentar dan coba lagi.</p>
